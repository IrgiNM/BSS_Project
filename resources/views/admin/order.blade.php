<x-admin>
    ...
    <div class="w-[100%] h-[1000px] ps-[240px] pe-[40px] bg-[#d6ebff] flex flex-col">
        ...
        <div class="w-[100%] bg-[#4a9fff] h-[50px] flex flex-row justify-between px-[50px] items-center rounded-[5px] mt-5">
        ...
        @foreach($items as $item)
            <div class="w-[100%] mt-3 bg-white h-[50px] flex flex-row justify-between px-[50px] items-center rounded-[5px]">
                <p class="text-[13px] py-2 w-[25px] h-[25px] flex justify-center items-center rounded-[5px] bg-[#91c5ff]">{{ $i }}</p>
                ...
                <p class="text-[13px] w-[120px] text-center py-2">
                    <img class="w-[25px] h-[25px] m-auto bg-cover" src="{{ asset('storage/'.$item->gambar) }}" alt="{{ $item->gambar }}">
                </p>
